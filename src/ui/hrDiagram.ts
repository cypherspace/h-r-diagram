...
export class HRDiagram {
  ...
  // wobble. Band half-width is ±0.6 dex in log L throughout (factor
  // of ~16 between top and bottom edges) so most of the curated
  // sample stars sit inside the band — real main-sequence scatter is
  // wider than ±0.4 dex once age and metallicity vary. Each tuple is
  // [T_eff (K), upper edge L_solar, lower edge L_solar].
