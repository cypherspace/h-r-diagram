...
// B-V color index. Coordinates are J2000 in decimal degrees.
...
// ---- sun-like stars (G-type main sequence) ----
const SUN_LIKE: Star[] = [
  {
    id: "sun",
    name: "Sun",
...
// ---- red dwarfs (M-type main sequence) ----
...
// Backwards-compatible flat list of every catalogued star, used by
// findStarById and as the default reference list when older saved
// diagrams refer to a sample by id.
